    ...
    <div class="container-scroller">
        ...
        <nav class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0">
            <div class="navbar-links-wrapper d-flex align-items-stretch">
                <div class="nav-link">
                    <a href="{{ asset('admin/javascript:;') }}"><i class="typcn typcn-calendar-outline"></i></a>
                </div>
                <div class="nav-link">
                    <a href="{{ asset('admin/javascript:;') }}"><i class="typcn typcn-mail"></i></a>
                </div>
                <div class="nav-link">
                    <a href="{{ asset('admin/javascript:;') }}"><i class="typcn typcn-folder"></i></a>
                </div>
                <div class="nav-link">
                    <a href="{{ asset('admin/javascript:;') }}"><i class="typcn typcn-document-text"></i></a>
                </div>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <ul class="navbar-nav mr-lg-2">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav" id="accordion-menu"> <!-- Wrapper for collapse grouping -->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="category-menu" data-parent="#accordion-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('category.create') }}">Add Category</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('category.index') }}">Category Details</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="product-menu" data-parent="#accordion-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('product.create') }}">Add Product</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('product.index') }}">Product Details</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <!-- Inward -->
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#inward-menu" aria-expanded="false"
                            aria-controls="inward-menu">
                            <i class="typcn typcn-film menu-icon"></i>
                            <span class="menu-title">Inword</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="inward-menu" data-parent="#accordion-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('inword.create') }}">Add Inword</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('inword.index') }}">Inword Details</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <!--User orders -->
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#user-menu" aria-expanded="false"
                            aria-controls="user-menu">
                            <i class="typcn typcn-user menu-icon"></i>
                            <span class="menu-title">Users</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="user-menu" data-parent="#accordion-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/users') }}">All Users</a>
                                </li>
                                {{-- You don’t need a static User Orders link because it's dynamic per user --}}
                            </ul>
                        </div>
                    </li>
