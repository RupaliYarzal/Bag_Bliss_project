                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-item">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ session('user_email') }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-item">
                            <textarea name="notes" class="form-control" placeholder="Order Notes (Optional)"></textarea>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="{{ asset('images/' . $item['pimage']) }}"
                                                        class="img-fluid rounded-circle" style="width: 90px; height: 90px;"
                                                        alt="">
                                                </div>
                                            </th>
                                            <td class="py-5">{{ $item['pname'] }}</td>
                                            <td class="py-5">Rs.{{ $price }}</td>
